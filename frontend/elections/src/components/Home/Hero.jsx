...
const HeroSection = () => {
  ...
  const slides = [
    { title: "صوتك يصنع التغيير", description: "شارك في بناء مستقبل أردن أفضل" },
    { title: "انتخابات شفافة ونزيهة", description: "نضمن لك تجربة انتخابية آمنة وعادلة" },
    { title: "قم بدورك في الديمقراطية", description: "كل صوت مهم في تشكيل مستقبلنا" },
  ];
  ...
  return (
    <section className="relative h-screen flex items-center justify-center text-center text-white overflow-hidden">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4">
        ...
        >
          {[
            { icon: Vote, title: "سهولة التصويت", description: "عملية تصويت بسيطة وآمنة" },
            { icon: Users, title: "مشاركة فعالة", description: "فرصتك للتأثير في القرارات" },
            { icon: PieChart, title: "نتائج شفافة", description: "متابعة فورية لنتائج الانتخابات" },
          ].map((feature, index) => (
            <motion.div
              key={index}
              whileHover={{ scale: 1.05 }}
