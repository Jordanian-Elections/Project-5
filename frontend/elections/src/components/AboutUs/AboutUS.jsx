      ...
      <main className="container mx-auto px-4 py-8">
        <section className="bg-white rounded-lg shadow-lg p-8 mb-8 mx-4 md:mx-24">
          ...
          <div className="space-y-8">
            <p className="text-xl text-gray-700 leading-relaxed text-center">
              ...
              مجموعة متخصصة تعمل بالتعاون الوثيق مع الهيئة المستقلة للانتخاب في
              الأردن. مهمتنا الأساسية هي ضمان نزاهة وشفافية وكفاءة العملية
              الانتخابية، وتعزيز المشاركة الديمقراطية لكل مواطن أردني. نسعى
              جاهدين لتقديم الدعم الفني والتقني من خلال أحدث الحلول الرقمية التي
              تضمن سير العملية الانتخابية بشكل سلس وآمن. نحن نؤمن بأن كل صوت له
              قيمة، ولذلك نركز على تسهيل وصول المواطنين إلى صناديق الاقتراع
              وضمان أن يكون لكل فرد القدرة على التعبير عن رأيه بكل حرية. نعمل
              بجد لنشر الوعي حول أهمية المشاركة في الانتخابات وتعزيز الثقة
              بالنظام الديمقراطي من خلال المبادرات والبرامج التوعوية التي تطمح
              إلى بناء مجتمع واعٍ وفاعل في الحياة السياسية.
            </p>
            ...
            <p className="text-xl text-gray-700 leading-relaxed text-center mt-8 bg-gray-100 p-6 rounded-lg">
              ...
              الانتخابية بسلاسة وشفافية. من خلال خبرتنا التقنية ومعرفتنا العميقة
              بالعملية الانتخابية، نساهم في تعزيز الثقة في النظام الديمقراطي
              الأردني. نحن ملتزمون بتقديم الحلول التقنية المتقدمة التي تضمن دقة
              وسرعة فرز الأصوات، مع مراعاة أعلى معايير الأمان والخصوصية. هدفنا
              هو أن يشعر كل مواطن بأن صوته مهم وأنه يساهم بشكل فعّال في رسم
              مستقبل البلاد. نحن هنا لضمان أن تكون العملية الانتخابية عادلة
              وشاملة، وتعكس الإرادة الحقيقية للشعب الأردني.
            </p>
          </div>
        </section>
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8 mx-24">
          <div className="bg-white rounded-lg shadow-lg p-6">
            ...
            <p className="text-gray-700">
              نحن نشجع جميع المواطنين الأردنيين على المشاركة الفعالة في العملية
              الانتخابية. من خلال الإدلاء بأصواتهم، يلعب المواطنون دورًا حاسمًا
              في تشكيل مستقبل البلاد وتحديد القضايا التي تهمهم. نؤمن بأن
              المشاركة الواسعة في الانتخابات هي العمود الفقري لديمقراطية قوية
              وصحية، ولذلك نسعى إلى تسهيل الوصول إلى مراكز الاقتراع وتوفير
              المعلومات الضرورية حول العملية الانتخابية. كما أننا نعمل على توعية
              المواطنين بأهمية أصواتهم وكيفية تأثيرها في اتخاذ القرارات على
              المستوى الوطني والمحلي. كل صوت له قيمة، ونحن هنا لضمان أن تُسمع
              أصوات الجميع بشكل عادل ومنصف.
            </p>
          </div>
          <div className="bg-white rounded-lg shadow-lg p-6">
            <img
            ...
            <p className="text-gray-700">
              ...
              النتائج. تتيح لنا الأنظمة الرقمية التي نستخدمها تحقيق شفافية عالية
              وتقليل احتمالات الخطأ البشري، مما يضمن أن تكون نتائج الانتخابات
              معبرة بدقة عن إرادة الشعب. كما نعمل على تحديث منصاتنا باستمرار
              للتكيف مع التحديات الجديدة وضمان أن تظل العملية الانتخابية متقدمة
              وآمنة. من خلال اعتماد التكنولوجيا، نطمح إلى تعزيز الثقة في النظام
              الانتخابي وتمكين المواطنين من المشاركة بكل سهولة وفاعلية.
            </p>
          </div>
        </section>
        ...
        <section className="bg-[#01332A] text-white rounded-lg shadow-lg p-8 mb-8 mx-12">
          ...
          <p className="text-lg text-center">
            نحن نلتزم بالشفافية والوضوح. اكتشف المزيد عن قوانين الانتخابات وتعرف
            على شركائنا في تنفيذ العملية الانتخابية الإلكترونية.
          </p>
        ...
        <section className="grid grid-cols-1 md:grid-cols-3 gap-8 mx-16">
          <div className="bg-white rounded-lg shadow-lg p-6">
            ...
            <p className="text-gray-700 text-center">
              نضمن الشفافية في كل مرحلة من مراحل العملية الانتخابية، من التخطيط
              إلى إعلان النتائج. نعمل على توفير معلومات واضحة ودقيقة للجميع، مما
          ...
          <div className="bg-white rounded-lg shadow-lg p-6">
            ...
            />
            <h3 className="text-xl font-bold text-center mb-2">سهولة الوصول</h3>
            <p className="text-gray-700 text-center">
              نسعى لجعل عملية التصويت سهلة ومتاحة لجميع المواطنين، من خلال توفير
              مراكز اقتراع مريحة وتقديم الدعم اللازم. نركز على إزالة أي عقبات قد
              تواجه الناخبين لضمان مشاركتهم الفعالة في العملية الانتخابية.
            </p>
          </div>
        </section>
